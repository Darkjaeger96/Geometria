...
public class TestGeometria {
	...
	public static void main (String args[]) {
		...
		System.out.println("Área del rectangulo de base 2.123 y altura 1.233 vale " + areaRectangulo);
		
		double areaTriangulo = Geometria.calcularAreaTriangulo(2.123, 1.233);
		System.out.println("Área del triangulo de base 2.123 y altura 1.233 vale " + areaTriangulo);
		
		double areaCirculo = Geometria.calcularAreaCirculo(2.123);
		System.out.println("Área del circulo de radio 2.123" + areaCirculo);
	}
}
